    ...
    <div>
        <section class="text-gray-600 body-font px-5 ">
            ...
            <div class = "py-4 px-2 flex justify-center">
                <h1 class = "font-extrabold text-4xl text-emerald-50 underline underline-offset-2">Gallery</h1>
            </div>
            <div class="">
            <div class="flex flex-wrap w-full bg-gray-100 py-32 px-10 relative mb-4 rounded-3xl	">
